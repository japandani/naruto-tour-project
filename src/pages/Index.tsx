...
const AirportBoard = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-[#0a0a0a]/70 backdrop-blur-sm rounded-lg shadow-2xl p-1.5 md:p-2.5 border-2 border-[#222]/50" style={{ 
      ...
      <div className="flex items-center justify-between mb-1 md:mb-1.5 pb-1 border-b border-[#333]/50">
      ...
      <div className="grid grid-cols-[auto_1fr_auto_auto] gap-2 md:gap-3 items-center mb-1 md:mb-1.5 text-[#ffa500] font-mono">
      ...
      <div className="grid grid-cols-2 gap-2 md:gap-3 pt-1 border-t border-[#333]/50">
        <div className="bg-[#1a1a1a]/60 rounded p-1 md:p-1.5 border border-[#333]/50">
          <div className="text-[9px] md:text-[10px] text-[#888] uppercase mb-0 tracking-wider">Длительность</div>
          <div className="text-base md:text-xl font-bold text-[#ffa500] font-mono tracking-tight">
            {renderText('14 ДНЕЙ', 5000)}
          </div>
        </div>
        <div className="bg-[#1a1a1a]/60 rounded p-1 md:p-1.5 border border-[#333]/50 flex flex-col justify-center">
