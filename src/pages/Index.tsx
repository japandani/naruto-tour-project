            ...
            <div className="relative">
              ...
              <div className="bg-gradient-to-br from-background via-secondary/20 to-background border-2 md:border-3 border-accent/30 rounded-lg shadow-xl p-3 md:p-6 relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row items-start gap-3 md:gap-4 relative z-10">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg md:text-xl lg:text-2xl font-bold mb-1 text-primary">Третий свиток: Дух</h3>
                    <p className="text-xs md:text-sm lg:text-base text-muted-foreground leading-relaxed">
            ...
            <div className="relative">
              ...
              <div className="bg-gradient-to-br from-background via-secondary/20 to-background border-2 md:border-3 border-accent/30 rounded-lg shadow-xl p-3 md:p-6 relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row items-start gap-3 md:gap-4 relative z-10">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg md:text-xl lg:text-2xl font-bold mb-1 text-primary">Четвёртый свиток: Единство</h3>
                    <p className="text-xs md:text-sm lg:text-base text-muted-foreground leading-relaxed">
                      Здесь сливаются все ключи — энергия, сердце и дух — в единое понимание. Вы поднимитесь на священную гору Коясан, где монахи хранят молчание и пламя неугасимых лампад горит уже тысячу лет. Переночуете в храме, участвуя в утренних молитвах и медитациях. Осознаете, что вы не просто путешественник — вы стали частью великого Пути. Теперь вы знаете Японию не умом, а сердцем.
                    </p>
                  </div>
                </div>
              </div>
