  ...
  const tourParts = [
    ...
    },
    {
      ...
      days: [
        ...
        {
          day: 8,
          title: "Канадзава — город золота и мастеров",
          description: "Утро в Канадзаве — городе, который когда-то был богаче Киото благодаря золотым приискам и мастерам по золочению. Замок Канадзава возвышается над городом, храня память о могущественном клане Маэда. Район Нагамати — бывший квартал самураев, где сохранились глинобитные стены и узкие каналы. Музей золотых листьев — здесь вы увидите, как создаётся сусальное золото, которым покрывают храмы и создают шедевры. Можно даже попробовать сделать позолоту самостоятельно. Рынок Омитё — гастрономическое сердце города, где торгуют свежайшими морепродуктами из Японского моря. Вечером — свободное время для прогулок по вечерней Канадзаве или повторного визита в квартал гейш."
        }
      ]
    },
    {
