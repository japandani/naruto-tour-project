  ...
  const tourParts = [
    ...
    },
    {
      ...
      days: [
        {
          day: 9,
          title: "Золото, камни, бамбук и храм на сваях",
          description: "Утро начинается с Кинкаку-дзи — Золотого павильона, настолько совершенного, что он кажется миражом. Его позолоченные стены отражаются в пруду, создавая иллюзию парения между небом и землёй. Это символ Киото, место, где красота достигает абсолюта. Затем — сад камней Рёан-дзи, величайшая загадка дзен-буддизма. Пятнадцать камней на белом гравии — это вселенная, это пустота и полнота одновременно. Здесь не нужно понимать — нужно чувствовать. Бамбуковая роща Арасиямы — тысячи стволов взмывают к небу, создавая зелёный собор, где свет фильтруется сквозь листву, а ветер создаёт музыку природы. Прогулка здесь — медитация в движении. Финал дня — Киёмидзу-дера, «храм чистой воды», возвышающийся на деревянных сваях над лесистым склоном. Отсюда открывается панорама на весь Киото — древний и вечный."
        },
        {
          day: 10,
