    ...
    },
    {
      ...
      days: [
        ...
        },
        {
          ...
          description: "Рассвет встречаем бегом к пагоде Арасиямы — утренняя тишина и первые лучи солнца делают этот момент волшебным. Затем начинается путешествие к священной Фудзи через маршрут пяти озёр — Кавагутико, Саико, Яманакако, Сёдзико и Мотосуко. Каждое озеро открывает новый ракурс на великую гору, каждая остановка — это открытка, ожившая перед глазами. В Мацумото вас ждёт встреча с одним из красивейших замков Японии — «Чёрной вороной», чьи тёмные стены отражаются в водах рва. Но сегодня особый день — в музее работает выставка Яёи Кусамы, королевы горошка и бесконечности, чьё искусство гипнотизирует и переворачивает восприятие. К вечеру въезжаете в альпийскую Такаяму, где воздух пахнет хвоей и древесиной старинных домов."
        },
        {
          day: 6,
          title: "Такаямский рынок, Санмачи-дори и путь в Канадзаву",
          description: "Утро на берегу реки Мия — такаямский рынок оживает с первыми лучами солнца. Бабушки в передниках раскладывают горные овощи, домашние соленья и свежие цветы. Аромат жареных рисовых шариков мицураси-данго смешивается с запахом хвои. Прогулка по улице Санмачи-дори — это путешествие в эпоху Эдо: деревянные дома купцов, лавки мастеров, старинные пивоварни саке. Здесь вас ждёт дегустация местного мисо (Такаяма славится им по всей Японии) и саке из горных источников. Для смелых — порция натто, ферментированных соевых бобов с резким запахом и тягучей текстурой (любовь к натто — показатель истинного понимания Японии). После обеда путь ведёт в деревню Сиракава-го — объект ЮНЕСКО, где дома с крышами гассё-дзукури, похожими на сложенные ладони, стоят уже 250 лет. К вечеру заезжаете в Канадзаву — город золота, садов и гейш."
        }
      ]
    },
    {
