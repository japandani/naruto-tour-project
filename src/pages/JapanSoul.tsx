        ...
        <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center text-white px-4 max-w-4xl">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 drop-shadow-lg">
              Япония: Открытие Нового Мира
            </h1>
            <p className="text-xl md:text-2xl mb-8 drop-shadow">
              Путешествие, которое удивит и изменит вас навсегда
            </p>
            <div className="flex flex-wrap gap-4 justify-center text-sm md:text-base">
              ...
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                ...
                <span>Откройте себя заново</span>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 -mt-20 relative z-20">
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Япония — это не просто страна. Это портал в другую реальность, где древние традиции сплетаются с футуризмом, где тишина храмов соседствует с неоновыми огнями мегаполисов, где каждый камень хранит тысячелетнюю историю.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Этот тур откроет вам Японию, которую вы не найдёте в путеводителях. Вы увидите не только знаковые места — Фудзи, Киото, Хиросиму — но и почувствуете душу страны. Вы пройдёте путь от океана до гор, от традиционных рёканов до скоростных синкансэнов, от бамбуковых рощ до атомного купола.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Япония удивит вас. Япония изменит вас. И вы вернётесь другим человеком — с новым взглядом на мир и на себя.
              </p>
            </div>
          </div>
        </section>
