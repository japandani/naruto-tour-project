...
export default function Blog() {
  ...
  const articles = [
    {
      id: 10,
      title: 'Первый раз за 60 лет я доверился другим. И не пожалел',
      subtitle: 'переведено с иврита',
      excerpt: 'История Гилада — главы семьи, который всю жизнь всё делал сам: строил программы, возил семью по Европе, планировал каждую деталь. В Японии он впервые доверился команде ДА. С полуслова. Трогательный рассказ о том, как отпустить контроль.',
      image: 'https://cdn.poehali.dev/files/b62a096f-9794-4d18-8e96-d57eb9010020.jpeg',
      date: '15 ноября 2024',
      readTime: '11 мин',
      category: 'Истории',
      fullText: `Меня зовут Гилад. Мне 60 лет. Я инженер на пенсии, отец двоих взрослых детей, дедушка трёх внуков. 

**Всю жизнь я всё делал сам**

Всю жизнь я строил программы. Всё сам планировал, всё сам организовывал. Каждый отпуск — я за рулём, я вёз семью по Европе, бронировал отели, прокладывал маршруты, решал проблемы. Я был тем, на кого все полагались.

Возил всю семью за границу: Италия, Франция, Германия, Чехия. Всегда сам за рулём. Сам везде. Я не привык доверять. Не потому что не верю людям — просто так проще: знаешь, что всё под контролем.

**Япония: первый раз без контроля**

Но в этот раз что-то изменилось. Жена сказала: "Гилад, тебе 60. Ты заслужил отдохнуть. Не планировать, не вести машину, не решать проблемы. Просто быть."

Я нашёл команду ДА. Написал Даниэлю пару строк: "Нам 60. Хотим Японию. Настоящую."

Он ответил: "Доверьтесь нам."

И я доверился. С полуслова. Впервые в жизни. Ни секунды не думал, что будет плохо. Просто отпустил контроль.

**День первый: встреча в Токио**

Даниэль встретил нас в Токио. С первых минут я почувствовал: этот человек понимает, что нам нужно. Не галопом по достопримечательностям. А настоящая Япония.

Мы начали с храма Рёан-дзи. Сад камней. 15 камней на белом гравии. Ни цветов, ни деревьев. Только камни, пустота и тишина.

Мы сидели на деревянной веранде минут сорок. Молча. Жена держала меня за руку. И я понял: вот оно. То, зачем мы приехали. Не фотографии, не впечатления. А вот эта тишина. Которой не было 40 лет.

**Бамбуковая роща Арасияма**

Даниэль привёл нас в бамбуковую рощу рано утром. Сказал: "Туристы придут в 9. У нас есть час."

Мы шли по аллее, и бамбук шелестел над головой, как живой. Жена остановилась, закрыла глаза, слушала. Потом сказала: "Гилад, я счастлива".

За 40 лет брака она говорила это редко. Но в тот момент я поверил каждому слову.

**Фудзияма: секрет, который мало кто знает**

Даниэль сказал: "Гилад, сегодня будет плохая погода. Это идеально."

Я не понял. Плохая погода — это плохо, разве нет?

Он улыбнулся: "Фудзи нужно снимать в плохой день. И обязательно со стороны моря. Мало кто это знает. Поехали на полуостров Идзу."

Мы приехали в нелюдное место — малоизвестный залив у маяка на полуострове Идзу. Никого. Только мы, море, скамейка и облачное небо.

Даниэль сказал: "Садитесь на скамейку. Смотрите на море. Ждите."

Мы сидели. Волны шумели. Ветер дул. И вдруг сквозь облака, над морем, величественно возникла Фудзи. Не яркая открыточная картинка. А настоящая, живая, дышащая гора.

Жена сжала мою руку. Я не мог оторвать глаз. Даниэль молча сделал фото.

Это фото теперь висит у нас в гостиной. Когда гости спрашивают: "Где это?", я отвечаю: "Место, о котором мало кто знает. Даниэль показал."
...
Япония вернула нам друг друга. Мы снова стали не "мама и папа", не "бабушка и дедушка". А Гилад и любовь всей моей жизни. Те, кто когда-то мечтал о Японии.

**Что я понял о себе**

Всю жизнь я думал, что контроль — это сила. Что настоящий мужчина должен всё держать в руках, всё решать, за всё отвечать.

А в Японии я понял: отпустить контроль — это не слабость. Это мудрость.

Даниэль не просто организовал поездку. Он освободил меня. От необходимости планировать, проверять, контролировать. Я впервые за 40 лет просто жил. Смотрел на Фудзи. Держал жену за руку. Слушал тишину.

**Ожидания оправдались. И даже больше.**

Я ожидал хорошую поездку. Получил — возвращение к себе.

Я ожидал увидеть Японию. Получил — понимание, что жизнь не заканчивается в 60. Она начинается заново.

**Прощание: самый трогательный момент**

Когда мы расставались с Даниэлем, я не знал, что сказать. Как благодарить человека, который вернул тебе ощущение жизни?

Я пожал ему руку. Крепко. По-мужски. И сказал: "Спасибо, что научил меня доверять."

Жена обняла его. Заплакала. Даниэль тоже не сдержался.

Мы стояли в аэропорту, трое взрослых людей, и плакали. Но это были не слёзы грусти. Это были слёзы благодарности.

**Команде ДА: вы изменили мою жизнь**

Я прожил 60 лет, думая, что должен всё делать сам. Что просить помощи — это слабость. Что довериться кому-то — это риск.

Вы показали мне, что доверие — это не риск. Это подарок. Себе и тем, кто рядом.

Спасибо вам за Японию. За Фудзи. За тишину. За то, что дали мне отдохнуть. Впервые за 60 лет.

**P.S. Внукам я сказал: "Когда вырастете, поедем в Японию. С Даниэлем. Он научит вас тому, чему научил меня: не бояться доверять."**

**P.P.S. То фото на фоне Фудзи — не просто снимок. Это момент, когда я понял: жизнь только начинается.**`
    },
    {
      id: 8,
