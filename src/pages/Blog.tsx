  ...
  const articles = [
    {
      ...
      readTime: '11 мин',
      category: 'Истории',
      fullText: `Меня зовут Владимир. Мне 60 лет. Я инженер на пенсии, отец двоих взрослых детей, дедушка трёх внуков. 
...
Но в этот раз что-то изменилось. Жена Елена сказала: "Володя, тебе 60. Ты заслужил отдохнуть. Не планировать, не вести машину, не решать проблемы. Просто быть."
