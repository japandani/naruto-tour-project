...
export default function Blog() {
  ...
  const articles = [
    {
      id: 10,
      title: '(переведено с иврита) Первый раз за 60 лет я доверился другим. И не пожалел',
...
Мы приехали на берег озера Кавагути. Было облачно. Жена расстроилась: "Значит, не увидим?"
...
Жена заплакала. Я обнял её. Даниэль молча сделал фото. Это фото теперь висит у нас в гостиной. Я смотрю на него каждый день.
